...
namespace Elixir::GUI
{
    class ELIXIR_API TextField : public Widget
    {
      public:
        ...
        void SetFont(const Ref<Font>& font) { m_Font = font; MarkRenderDirty(); }

        float GetFontSize() const { return m_FontSize; }
        void SetFontSize(const float size) { m_FontSize = size; MarkRenderDirty(); }

        const std::string& GetText() const { return m_Text; }
        void SetText(const std::string& text) { m_Text = text; MarkRenderDirty(); }
        ...
        void SetPlaceholder(const std::string& placeholder) { m_Placeholder = placeholder; MarkRenderDirty(); }

        SColor GetPlaceholderColor() const { return m_PlaceholderColor; }
        void SetPlaceholderColor(const SColor& color) { m_PlaceholderColor = color; MarkRenderDirty(); }

        SPadding GetPadding() const { return m_Padding; }
        void SetPadding(const SPadding& padding) { m_Padding = padding; MarkRenderDirty(); }
        ...
        void SetBackgroundColor(const SColor& color) { m_BackgroundColor = color; MarkRenderDirty(); }
        ...
        void SetBackground(const Ref<Texture2D>& texture) { m_Background = texture; MarkRenderDirty(); }

        SColor GetCursorColor() const { return m_CursorColor; }
        void SetCursorColor(const SColor& color) { m_CursorColor = color; MarkRenderDirty(); }

        SColor GetSelectionColor() const { return m_SelectionColor; }
        void SetSelectionColor(const SColor& color) { m_SelectionColor = color; MarkRenderDirty(); }
