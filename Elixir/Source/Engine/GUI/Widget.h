...
namespace Elixir::GUI
{
    ...
    class ELIXIR_API Widget
    {
      ...
      protected:
        // Assign geometry and invalidate this widget's draw-command cache (position changed).
        void SetGeometry(const SRect& geometry) { m_Geometry = geometry; MarkRenderDirty(); }
