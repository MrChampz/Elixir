#include "epch.h"
#include "MaterialFrameTable.h"

namespace Elixir
{
    MaterialFrameTable::MaterialFrameTable(
    ...
    std::optional<uint32_t> MaterialFrameTable::Add(const MaterialRenderProxy& material)
    {
    ...
    std::optional<uint32_t> MaterialFrameTable::Find(const MaterialRenderProxy& material) const
    {
    ...
    SMaterialFrameData MaterialFrameTable::BuildData(const MaterialRenderProxy& material) const
    {
