...
namespace Elixir
{
    ...
    uint32_t MaterialRenderScene::AddGeometry(SMaterialRenderGeometry geometry)
    {
        EE_CORE_ASSERT(
    ...
    const SMaterialRenderGeometry* MaterialRenderScene::FindGeometry(const uint32_t index) const
    {
